...
! function a(b, c, d) {
    ...
    9: [function(a, b) {
        ...
        i(c.prototype, e.prototype), i(c.prototype, f.prototype), c.prototype.add = function(a) {
            ...
            var b = 0;
            return b += this.subtotal(),
                b -= this.discount(),
                a = a || {},
                a.currency = this.settings("currency_code"),
                h(b, a)
        }, c.prototype.remove = function(a) { var b = this._items.splice(a, 1); return 0 === this._items.length && this.destroy(), b && (this.save(), this.fire("remove", a, b[0])), !!b.length }, c.prototype.save = function() {
